...
def buscarPalabraAleat(listaPalabras):
    # Esta funcion tomara una palabra aleatoria.
...
def empezar():
    # La funcion devuelve True si el jugador quiere volver a jugar, de lo contrario devuelve False
